...
import com.smilexie.retrofitsoap.webservice.response.MyConvertBodyFactor;
...
//    public final static String BASE_URL = "http://www.webxml.com.cn/WebServices/";
    public final static String BASE_URL = "http://v4.365edai.cn:36549";
   ...
   private static Retrofit.Builder retrofitBuilder =  new Retrofit.Builder()
            .addConverterFactory(new MyConvertBodyFactor())
            .baseUrl(BASE_URL);
